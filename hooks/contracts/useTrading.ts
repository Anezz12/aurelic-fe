...
export const useTradingHooks = () => {
  ...
  // Execute swap function - Merchant Moe DEX interface via RestrictedWallet
  const executeSwap = async (
    ...
    try {
      ...
      console.log("Executing Merchant Moe swap via RestrictedWallet:", {
      ...
      // Execute swap through RestrictedWallet's Merchant Moe interface
      await writeContract({
 ...
 * Uses Merchant Moe on-chain quote for accurate pricing
 */
