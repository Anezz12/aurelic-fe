...
} from "../../hooks/contracts/useTrading";
...
export const TradingPage: React.FC = () => {
  ...
  const loanAmount = loanInfo?.loanAmount
    ? formatUSDC(loanInfo.loanAmount)
    : "0";
          ...
          {!loanInfo ? (
              ...
              <div className="bg-[#0A0A0A] rounded-lg border border-[rgba(6,182,212,0.15)] p-4">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p
                      className="text-white font-mono text-sm font-normal"
                      style={{ fontFamily: "Space Grotesk" }}>
                      {restrictedWalletAddress.slice(0, 6)}...
                      {restrictedWalletAddress.slice(-4)}
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-[#0A0A0A] rounded-lg border border-[rgba(255,193,7,0.15)] p-4">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p
                          className="text-[#FFC107] font-normal"
                          style={{ fontFamily: "Space Grotesk" }}>
              ...
              {allTokensWhitelisted && (
                <div className="bg-[#0A0A0A] rounded-lg border border-[rgba(34,197,94,0.15)] p-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p
                        className="text-[#22C55E] font-normal"
                        style={{ fontFamily: "Space Grotesk" }}>
                        All Tokens Whitelisted
                      </p>
                      <p
                        className="text-gray-400 text-sm"
                        style={{ fontFamily: "Space Grotesk" }}>
            ...
            <div className="bg-[#0A0A0A] rounded-lg border border-[rgba(6,182,212,0.15)] p-4">
              <div className="text-center">
                ...
                <p
                  className="text-yellow-400 font-normal mb-2"
                  style={{ fontFamily: "Space Grotesk" }}>
                  No active trading wallet
                </p>
                <p
                  className="text-[#A3A3A3] text-sm mb-3 font-normal"
                  style={{ fontFamily: "Space Grotesk" }}>
                ...
                <div className="space-y-2">
                  ...
                  <div className="bg-gray-800/50 border border-gray-600/50 rounded-lg p-4">
                        ...
                        {restrictedTokenInBalance ? (
                          <span className="text-sm text-gray-400">
                            ...
                            <span className="text-white font-medium">
                              {formatTokenAmount(
                                restrictedTokenInBalance as bigint,
                                tokenIn.decimals
                              )}
                            </span>{" "}
                            {tokenIn.symbol}
                    ...
                    {restrictedWalletAddress &&
                      ...
                      tradeAmount &&
                      (() => {
                        const restrictedBalance = formatTokenAmount(
                          restrictedTokenInBalance as bigint,
                          tokenIn.decimals
                        );
                        const hasInsufficientRestrictedBalance =
                          parseFloat(restrictedBalance) <
                          parseFloat(tradeAmount);
                        return (
                          hasInsufficientRestrictedBalance && (
                            <div className="mt-3 p-2 bg-red-900/20 border border-red-500/30 rounded">
                              <p className="text-red-400 text-sm">
                                Insufficient {tokenIn.symbol} in restricted
                                wallet
                              </p>
                              <p className="text-gray-400 text-sm">
                                Available: {restrictedBalance}
                              </p>
                            </div>
                          )
                        );
                  ...
                  <div className="flex justify-center py-1">
                    <button
                      ...
                      <svg
                        className="w-4 h-4 text-gray-300 group-hover:text-white transition-colors duration-300 group-hover:rotate-180"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 24 24">
                        <path
                      ...
                      <div className="text-right">
                        {restrictedTokenOutBalance ? (
                          <span className="text-sm text-gray-400">
                            ...
                            <span className="text-white font-medium">
                              {formatTokenAmount(
                                restrictedTokenOutBalance as bigint,
                                tokenOut.decimals
                              )}
                            </span>{" "}
                            {tokenOut.symbol}
      ...
      <div className="bg-black rounded-lg border border-gray-700 p-5 sticky top-6">
        ...
        <div className="space-y-3">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="text-teal-400">
              {estimatedOutput} {tokenOut.symbol}
            </span>
          </div>
        ...
        {hasInsufficientBalance && isConnected && (
          <div className="mt-3 p-2 bg-red-900/20 border border-red-500/30 rounded">
            <p className="text-red-400 text-xs">
              Insufficient USDC balance for margin requirement
            </p>
          </div>
        )}
        ...
        {restrictedWalletAddress &&
          ...
          (() => {
            ...
            const hasInsufficientRestrictedBalance =
              parseFloat(restrictedBalance) < parseFloat(tradeAmount);
            return (
              hasInsufficientRestrictedBalance && (
                <div className="mt-3 p-2 bg-red-900/20 border border-red-500/30 rounded">
                  <p className="text-red-400 text-xs">
                    Insufficient {tokenIn.symbol} in restricted wallet.
                    Available: {restrictedBalance} {tokenIn.symbol}
                  </p>
                </div>
              )
            );
        ...
        {hasActiveLoan && !restrictedWalletAddress && (
          <div className="mt-3 p-2 bg-blue-900/20 border border-blue-500/30 rounded">
            <p className="text-blue-400 text-xs">
              You have an active loan. Use it to trade or close it first.
            </p>
          </div>
        )}
          ...
          {restrictedWalletAddress &&
            (() => {
              const restrictedBalance = restrictedTokenInBalance
                ...
                : "0";
              const hasInsufficientRestrictedBalance =
                parseFloat(restrictedBalance) < parseFloat(tradeAmount || "0");
